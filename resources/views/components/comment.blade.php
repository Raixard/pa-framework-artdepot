...
<div class="flex flex-col space-y-2">
    ...
    @if ($comment->user_id != null)
        ...
        <div class="flex space-x-3 {{ $margin ? 'ml-8' : '' }}">
            ...
            <a href="{{ route('userShow', $comment->user->username) }}" class="relative flex items-center w-12 h-12 aspect-square rounded-full">
            ...
            <div class="flex flex-col w-full bg-polar1 pt-3 pb-6 px-6 rounded-lg">
                ...
                <div class="flex flex-col mb-2 sm:flex-row sm:justify-between sm:items-center">
                    <a href="{{ route('userShow', $comment->user->username) }}" class="font-bold truncate transition-colors hover:text-frost3 focus:text-frost3"
                        tabindex="0">
