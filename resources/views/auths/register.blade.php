    ...
    <div class="container my-6 mt-20 mx-auto px-6 sm:px-auto grid md:grid-cols-4 auto-cols-fr">
        ...
        <div class="flex flex-col items-center rounded-lg px-6 py-6 space-y-3 bg-polar2 md:col-span-2">
            ...
            <div class="bg-aurora3/40 px-3 py-6 w-full rounded-lg">
                <b>Yeah!</b> Sukses! Tapi beneran yahahahahaha!!!
            </div>
            ...
            <form action="" method="POST" class="w-full">
                ...
                <div class="flex flex-col w-full space-y-3 mb-6">
                    ...
                    <input type="text" placeholder="Masukkan username Anda..." name="username" id="reg-username" required
                        pattern="[A-Za-z0-9_]{4,32}" class="p-3 rounded-lg text-polar0 outline-none">
                </div>
                ...
                <div class="flex flex-col w-full space-y-3 mb-6">
                    ...
                    <input type="password" placeholder="Masukkan kembali password Anda..." name="confirm-password"
                        id="reg-confirm-password" required class="p-3 rounded-lg text-polar0 outline-none">
                </div>
